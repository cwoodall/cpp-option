...
class Option final {
 ...
 Option(const Option<T> &other) : isSomething_(other.isSomething_), something_(other.something_) {}
 ...
 Option(Option &&other) : something_(other.something_), isSomething_(other.isSomething_) {
  }

  inline constexpr operator bool(void) const { return isSomething_; }
  inline constexpr T unwrap(void) const { return something_; }
  inline constexpr T unwrap_or(T or_val) const { return (isSomething_)?something_:or_val; }
